...
public class EdkDll
{
    ...
    static extern void Unmanaged_IS_GetBatteryChargeLevel(IntPtr state, out Int32 chargeLevel, out Int32 maxChargeLevel);
	    ...
	    static extern Int32 IEE_ConnectEpocPlusDevice(int index,bool isSettingMode = false);
	...
	[DllImport("__Internal")]
	public static extern Int32 IEE_ConnectEpocPlusDevice(Int32 index, bool isSettingMode = false);
	...
	{
		return jc.CallStatic<int>("IEE_ConnectEpocPlusDevice", index);
	}
